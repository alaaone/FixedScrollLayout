...
public class GridViewPageFragmentFixedScrollLayout extends FixedScrollLayoutBaseFragment {
    private static final int ITEM_COUNT = 33;

    private RecyclerView mGridView;
    private List<String> mItemList;

    public static GridViewPageFragmentFixedScrollLayout createInstance() {
        final GridViewPageFragmentFixedScrollLayout pageFragment = new GridViewPageFragmentFixedScrollLayout();
